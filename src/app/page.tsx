          ...
          <FadeInUp>
            <div className="bg-brand-dark rounded-3xl md:rounded-[40px] overflow-hidden shadow-2xl relative">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                {/* Left Side: Content */}
                <FadeInLeft delay={0.2} className="p-5 sm:p-6 md:p-10 lg:p-16 flex flex-col justify-center text-white relative lg:border-r border-white/10">
                ...
                {/* Right Side: Form */}
                <FadeInRight delay={0.3} className="p-6 md:p-10 lg:p-16 bg-slate-900/30">
                  <div className="mb-10">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-white mb-3 md:mb-4">Get Your FREE Software Consultation</h2>
                    <p className="text-slate-400 text-lg">Tell us about your project and receive a custom development roadmap.</p>
                  </div>
                  <ConsultancyForm />
                </FadeInRight>
              </div>
